...
//set margins
$pdf->SetMargins(12, 10, 4, 10); // left = 2.5 cm, top = 4 cm, right = 2.5cm
...
$html .= '<th  width="25%" align="center">ชื่อ</th>';
$html .= '<th  width="25%" align="center">วัด</th>';
$html .= '<th  width="25%" align="center">ตำแหน่ง</th>';
$html .= '<th  width="20%" align="center">วัน/เวลา</th>';
$html .= "</tr>";
$html .= "</thead>";
...
$sql = "SELECT
        ...
        WHERE time.detail_id = '$detail_id'
        AND time.members_nationalid IN (
            SELECT meeting_nationalid
            FROM meeting_mem
        )
...
$t = $p++;
  ...
  $html .= "<td width=\"25%\">$pname $pchaya $plastname</td>";
  $html .= "<td width=\"25%\">$pwat_name</td>";
  $html .= "<td width=\"25%\">$pposition_name</td>";
  $html .= "<td width=\"20%\">$pdate_scan</td>";
  $html .= "</tr>";
}
$html .= "</tbody>";
$html .= "</table>";
